...
<<<<<<< HEAD
    ...
    public void printLabel(String customer,String productCode,String count)
    {
        ...
        //customer
        int customerfontSize = calculateFontSize(customer,800,300);
        ...
        int customerstartX = 1215 - ((1215 - customertextWidth) / 2);
        
        //count
        int countfontSize = calculateFontSize(count,300,200);
        ...
        int countstartX = 1215 - ((1215 - counttextWidth) / 2);
        
        //productCode
        int productCodefontSize = calculateFontSize(productCode,300,200);
        ...
        int productCodestartX = 1215 - ((1215 - productCodetextWidth) / 2);
